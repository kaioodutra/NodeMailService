const serverEmailHTML = (props) => {
  //General Configs
  const title = "E-mail Automático da EmpresaX"
  const logo =
  ...
  const email = props.email ? props.email : "Email"
  const phone = props.phone ? props.phone : "Telefone"
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                      <tr>
                        <td style="font-family: sans-serif; font-size: 14px; vertical-align: top; color: ${primaryColor}">
                          ...
                          <br>
                          <br>
                          <p style="font-family: sans-serif; font-size: 18px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Mensagem vinda do Site da ${companyName}!</p>
                          <br>
                          <br>
                          <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;"><b>Nome </b>${name}</p>                                                            
                          <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;"><b>Assunto </b>${subject}</p>                                                            
                          <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;"><b>Telefone </b>${phone}</p>                                                            
                          <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;"><b>E-mail </b>${email}</p>                                                            
                          <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;"><b>Mensagem </b>${message}</p>                                                            
                          <br>
                          <br>
                          <br>
                          <br>
                          <br>            
                          <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;"><i>Enviada por <b>${name}</b>, dia ${dia} de ${mesString} de ${ano} às ${horas}:${minutos}h</i></p>
                        </td>
                      </tr>
                    </table>
                  </td>
...
module.exports = serverEmailHTML
